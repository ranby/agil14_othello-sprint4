...
/**
 * The responsibility of an OthelloNode is to keep information of where it is located on the board, who it is occupied
 * by and inform observers when occupied by another player.
 */
public class OthelloNode extends Observable implements Node  {
     ...
     *
     * @param node the node which the OthelloNode is based on
     */
    public OthelloNode(Node node) {
    ...
    /**
     * Creates a new OthelloNode with provided coordinates
     * and without an occupant
     *
     * @param x the x-coordinate of the OthelloNode
     * @param y the y-coordinate of the OthelloNode
     */
     ...
     * @param x the x-coordinate of the OthelloNode
     * @param y the y-coordinate of the OthelloNode
     * @param occupantPlayerId the player ID of the occupant
     */
