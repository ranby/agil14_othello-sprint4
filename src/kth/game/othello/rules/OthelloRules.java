...
/**
 * The responsibility of the OthelloRules is to define when a player can make a
 * move and in that case also determine what nodes to swap at the OthelloBoard.
 */
public class OthelloRules implements Rules {
	private OthelloBoard board;

	/**
	 * Creates a new OthelloRules instance using the provided OthelloBoard
	 *
	 * @param board
	 *            the OthelloBoard containing the nodes of the game
	 */
	...
	/**
	 * Returns a sequence of marked nodes following a vector from a given
	 * starting point
	 *
	 * @param x
	 ...
	 * @param playerId
	 *            the id of the first node in the sequence
	 * @return a sequence of marked nodes following a vector from a given
	 *         starting point
	 */
